...
const ANIMATIONS = {
    ...
    'CC-03': {
        ...
        steps: [
            ...
            {
                txt: "6. Visión Panorámica CCO: El Centro de Control supervisa la fluidez del tráfico y la efectividad de las alertas preventivas en todo el corredor.",
                meta: "OVERVIEW: TRAFFIC_FLOW_MONITORED",
                logs: ["[9.0s] CCO: OPTIMIZED_FLOW_SYNC", "[10s] VMS: STATUS_ACTIVE_MONITOR"],
                action: (scene) => scene.moveTo(5)
            }
        ]
    },
