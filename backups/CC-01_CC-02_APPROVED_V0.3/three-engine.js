...
class ThreeEngine {
    ...
    getStepMapping(idx) {
        ...
        const maps = {
            ...
            'CC-03': [
                { target: 0, cam: { x: 35, y: 35, z: 90 }, look: { x: 0, y: 3, z: 40 } },
                { target: 0, cam: { x: 45, y: 40, z: 95 }, look: { x: 0, y: 20, z: 50 } },
                { target: 0, cam: { x: 60, y: 50, z: 20 }, look: { x: 0, y: 20, z: 50 } },
                { target: 0, cam: { x: 40, y: 30, z: -20 }, look: { x: 0, y: 20, z: 50 } },
                { target: 0, cam: { x: 25, y: 15, z: 40 }, look: { x: 0, y: 10, z: 50 } },
